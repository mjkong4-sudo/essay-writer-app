  ...
  const saveToDictionary = useCallback(
    async (word: string, translationText: string, sourceLang: string, targetLang: string) => {
      try {
        ...
        // Silent fail -- dictionary save is non-critical
      }
    },
    [],
  );
    ...
    <div className="rounded-lg border border-border bg-card p-4 shadow-sm sm:p-6">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <h3 className="font-serif text-lg font-semibold">Edit Your Essay</h3>
          {versionLabel && (
      ...
      <div className="space-y-4">
        <div>
          <textarea
            ...
            className="min-h-[300px] w-full resize-y rounded-md border border-border bg-white p-4 font-sans text-sm leading-relaxed text-foreground placeholder:text-muted/50 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
            placeholder="Your generated essay will appear here. You can edit it freely..."
          />
          <p className="mt-1 text-xs text-muted">
            <span className="sm:hidden">Tip: Double-tap a word to translate it</span>
